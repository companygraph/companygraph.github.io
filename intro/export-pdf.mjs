...
// fallback exists in two: companygraph-de.pdf and companygraph-en.pdf.
...
for (const lang of LANGS) {
  ...
  const out = path.join(here, `companygraph-${lang}.pdf`);
  writeFileSync(out, await pdf.save());
  console.log(`  ✓ intro/companygraph-${lang}.pdf  (${count} slides)`);
}
